...
export const _cargo = (index: number) =>
  [
    'Administrador',
    'Gestor de Vendas',
...
export const _email = (index: number) =>
  [
    ...
    'Brandon Von',
    'Willis Ankunding',
  ][index].toLowerCase().replace(' ', '.') + '@example.com';

export const _company = (index: number) =>
  [
    'Rua Principal, 123',
  'Avenida Carvalho, 456',
  'Rua do Pinheiro, 789',
  'Rua do Carvalho, 101',
  'Rua Bétula, 202',
  'Rua do Cedro, 303',
  'Rua do Olmo, 404',
  'Rua do Abeto, 505',
  'Avenida Nogueira, 606',
  'Boulevard Castanheiro, 707',
  'Rua Freixo, 808',
  'Rua de Nogueira, 909',
  'Rua do Choupo, 111',
  'Rua do Cipreste, 222',
  'Avenida Salgueiro, 333',
  'Boulevard Sequoia, 444',
  'Rua Magnólia, 555',
  'Rua Sicômoro, 666',
  'Avenida Palmeira, 777',
  'Rua Abeto, 888',
  'Rua Zimbro, 999',
  'Rua Faia, 121',
  'Rua Amieiro, 232',
  'Avenida Corniso, 343',
  'Boulevard Sequóia, 454',
  ][index];
